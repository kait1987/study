...
<body>
	...
	<div class="container">
		...
		<table class="table table-hover">
			...
			<tr style="font-size: 20px;" align="center">
				...
				<td><%=productDto.getProduct_amount() %>
					<button onclick="add()" class="btn btn-info">+</button> <%=productDto.getProduct_amount() %>
					<button onclick="del()" class="btn btn-info">-</button></td>
				<td><%=decimalFormat.format(sum)%></td>
				<td><a
					href="cartdeletecontroller.jsp?sw=1&pcode=<%=productDto.getProduct_code() %>">삭제</a>
				</td>
			</tr>
			<%	
		...
		<div align="right">
			<a href="cartdeletecontroller.jsp?sw=0" class="btn btn-info"> 모두
				비우기 </a>
		</div>
	...
	<div class="container" style="margin-top: 50px; margin-bottom: 50px;">
		<div align="center"
			style="text-align: center; background-color: #D3302F; height: 100px; margin-bottom: 50px;">
		...
		<div align="center" style="margin-bottom: 50px;">
			<a href="payment.jsp?orderpay=<%=orderpay %>" class="btn btn-info">
				주문 하기</a> <a href="#" class="btn btn-info" style="margin-left: 20px;">
				계속 쇼핑하기 </a>
		</div>

		<div style="border: 1px solid gray; padding: 30px;">
			<div style="margin-bottom: 20px; font-size: 20px;">이용안내</div>
			<div>
				장바구니 이용안내
				<ol>
