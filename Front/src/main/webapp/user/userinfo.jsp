	...
	<div class="container">
		...
		<ul class="nav navbar-tabs nav-justified">
			...
			<li class="nav-item"><a class="nav-link" data-toggle="tab"
				href="#order">주문목록</a></li>

			<li class="nav-item"><a class="nav-link active"
				data-toggle="tab" href="#info">회원정보</a></li>
			...
			<div class="tab-pane fade" id="info">
				<div>
					<table>
						...
						<tr>
							<td>성명:<%=userDto.getUname() %>
							</td>
						</tr>

						<tr>
							<td>주소:<%=userDto.getUaddress() %>
							</td>
						</tr>

						<tr>
							<td>이메일:<%=userDto.getUemail() %>
							</td>
						</tr>

						<tr>
							<td>포인트:<%=userDto.getUpoint() %>
							</td>
						</tr>
					</table>
				</div>
			...
			%>
					...
					<form method="post" action="userupdatecontroller.jsp">
						...
						<input type="hidden" name="oldaddress"
							value="<%=userDto.getUaddress()%>"> <input type="hidden"
							name="oldpassword" value="<%=userDto.getUpassword()%>">
						<table>
							<tr>
								<td>아이디 : <%=loginid %>
								</td>
							...
							<tr>
								<td>성명 : <input type="text" value="<%=userDto.getUname()%>"
									name="name"></td>
							</tr>
								...
								<td>새로운주소 :
									<div>
										<input type="text" id="sample4_postcode" placeholder="우편번호"
											name="adress1" class="form-control">
									</div>
									<div class="col-lg-4">
										<input type="button" style="margin-top: 23px;"
											onclick="sample4_exeDaumPostcode()" value="주소 검색"
											class="form-control">
									</div>
									<div class="col-lg-6">
							...
							<tr>
								<td>이메일 : <input type="email"
									value="<%=userDto.getUemail()%>" name="email"></td>
							</tr>
						</table>
