	...
	<div id="mycarousel" class="carousel slide" data-ride="carousel"
		...
		<div class="carousel-inner">
			<div class="item active">
				<a href="#"><img src="../img/main1.jpg"
					class="img-responsive center-block"></a>
			</div>
			<div class="item">
				<a href="#"><img src="../img/main2.jpg"
					class="img-responsive center-block"></a>
			</div>
			<div class="item">
				<a href="#"><img src="../img/main3.jpg"
					class="img-responsive center-block"></a>
			</div>
	...
	<div class="container">
		<div class="goodslist" id="goodslist_best">
			...
			<ul>
				...
				<!-- 반복문 -->
				<li class="main_li"><a
					href="../product/productview.jsp?pcode=<%=productDto.getProduct_code() %>">
					...
					<div class="goods_info">
						...
						<span class="price"> <%= decimalFormat.format( productDto.getProduct_price() ) %>
						</span>
