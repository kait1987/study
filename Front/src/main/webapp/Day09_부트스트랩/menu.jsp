...
@font-face {
	...
	src:
		url("https://cdn.jsdelivr.net/gh/projectnoonnu/noonfonts_2102-01@1.0/Eulyoo1945-SemiBold.woff");
	format ('woff');
	font-weight: normal;
	font-style: normal;
}
	...
	<nav class="navbar navbar-default navbar-fixed-top"
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a href="main.jsp"> <img alt="" src="logo.png"
					style="width: 120px; padding: 20px;"></a>
			</div>
			<div id="navbar" class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<!-- 드롭다운시작 --> <a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
						aria-expanded="false"> top <span class="caret"></span>
					</a>
				...
				%>
					<li><a href="boardlist.jsp" style="font-size: 13px;">공지사항</a>
					</li>
					...
					<li><img alt="" src="cart.png" width="40px;"
						style="padding-top: 10px;"></li>
				</ul>
