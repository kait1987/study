...
//		1. 3개의 정수를 입력받아 가장 작은 수 출력
//		System.out.print(" 두개의 정수 입력 : "); 
//		int 정수1  = scan.nextInt();
//		int 정수2 = scan.nextInt();
//		int 정수3 = scan.nextInt();
//		int min = 정수1; // 가장 작은 값을 저장하는 변수
//		if( min > 정수2) min = 정수2; // 정수1이 정수 2보다 작으면 정수2로 대체
//		if( min > 정수3) min = 정수3;
//		System.out.println("가장 작은 수는 : "+ min);
		
//		2. 3개의 정수를 입력받아 오름차순으로 다시 저장하기
//		System.out.print(" 두개의 정수 입력 : "); 
//		int 정수1  = scan.nextInt();
//		int 정수2 = scan.nextInt();
//		int 정수3 = scan.nextInt();
//		
//		if (정수1 > 정수2) { //1번값과 2번값과 비교
//			int 임시 = 정수1;
//			정수1 = 정수2;
//			정수2 = 임시;
//			
//		}
//		if (정수2 > 정수3) { //2번 값과 3번값 비교
//			int 임시 = 정수2;
//			정수2 = 정수3;
//			정수3 = 임시;
//		}
//		if (정수1 > 정수2) { // 1번값과 2번 값 비교 후결과같을  교환
//			int 임시 = 정수1;
//			정수1 = 정수2;
//			정수2 = 임시; 
//		}
//		
//		System.out.println("오름차순 정렬 후 : " + 정수1 +"\t"+ 정수2+"\t" + 정수3 + "순 입니다." );
		
//		3. 아이디 qew405060 비밀번호 1234 회원 한명이 존재 했을때 
...
//		System.out.println("비밀번호"); String loginPassword = scan.next();
//		
		...
		while( true ) { //전체코드 무한루프
			...
			while ( true ) { // 구매 코드 반복
				...
				if (선택 == 2) {
					...
					if( 구매수 > 사이다재고 ) System.out.println("재고가 부족 합니다.");
					else if( ( 구매수*600) > 금액) { System.out.println("금액이 부족합니다.");
					}else {
						System.out.println("장바구니에 추가 했습니다.");
						
						int 사이다가격= 구매수*600;
							int temp = 장바구니금액 +사이다가격;
						if(temp > 금액 ) System.out.println("금액 부족");
						else{System.out.println("장바구니에 추가 했습니다.");
						장바구니금액 += 사이다가격;
						사이다구매수 += 구매수;
						}
						}
					...
					if (선택 == 3) {
						...
						if( 구매수 > 환타재고 ) System.out.println("재고가 부족 합니다.");
					...
					if (선택 == 4) {
						...
						if(콜라구매수 !=0) System.out.println("콜라 : " + 사이다구매수 + "총 금액: " + (사이다구매수*600));
						if(콜라구매수 !=0) System.out.println("콜라 : " + 환타구매수 + "총 금액: " + (환타구매수*700));
